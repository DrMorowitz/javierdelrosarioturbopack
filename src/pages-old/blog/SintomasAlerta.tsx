...
const SintomasAlerta = () => {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: 'Inicio', url: '/' },
    { name: 'Blog', url: '/blog' },
    { name: 'Síntomas de Alerta', url: '/blog/sintomas-alerta' }
  ]);

  const articleSchema = generateArticleSchema(
    'Síntomas de Alerta Urológica: Cuándo Consultar Inmediatamente',
    'Reconoce los síntomas que requieren atención médica urgente. Una respuesta rápida puede salvar tu riñón, vejiga o testículo.',
    '2025-09-15T00:00:00Z',
    '2025-09-15T00:00:00Z',
    '/blog/sintomas-alerta'
  );
              ...
              <div className="medical-card bg-primary/5">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="bg-red-600 hover:bg-red-700" onClick={() => {
                    const message = encodeURIComponent('URGENTE: Tengo síntomas de alarma urológica y necesito consulta inmediata.');
