              ...
              <div className="medical-card bg-primary/5">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button variant="outline" size="lg" asChild>
                    <Link href={`https://wa.me/50760000000?text=${encodeURIComponent('Hola Dr. del Rosario, tengo síntomas urológicos y me gustaría agendar una consulta.')}`} target="_blank">
